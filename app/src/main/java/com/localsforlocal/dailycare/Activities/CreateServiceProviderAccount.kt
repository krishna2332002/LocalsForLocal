...
import com.localsforlocal.dailycare.databinding.ActivityCreateServiceProviderAccountBinding
...
class CreateServiceProviderAccount : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database.child("Services").child(serviceName).addValueEventListener(object :
            ValueEventListener {
